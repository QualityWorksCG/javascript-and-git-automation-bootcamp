describe('Exercise 08', () => {
    ...
    test('Create a Vehicle class, and create different type of vehicles that extends', () => {
        class Vehicle {
            constructor (vehicleName, wheels, bodyType) {
        ...
        class Child extends Vehicle {
            constructor(vehicleName, wheels, whatIsMyName, color){
                super(vehicleName, wheels);
                this.color = new color(color)
                this.whatIsMyName = new bodyType(whatIsMyName)
            }
        }
