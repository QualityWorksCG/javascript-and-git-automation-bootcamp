describe('02', () => {
    it('02. Create a new string from any string by taking the last 3 letters of that string and adding it to the front and back.', () => {
        ...
        function lastThree(str) {
            ...
            //the "substring" finds a substring(part of a string)
            //therefore, i am finding a part of the string that begins at the length minus three
            let result = str.substring(str.length-3);
