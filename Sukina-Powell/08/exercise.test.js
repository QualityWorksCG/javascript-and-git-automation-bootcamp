describe('08', () => {
    ...
    test('Create a Vehicle class, and create different type of vehicles that extends', () => {
        ...
        {
            constructor(color,cWheels,cBodyType)
            {
                super(cWheels,cBodyType);
                this.color=color;
            }
            whatIsMyName(bodyType)
            {
        ...
        {
            constructor(color,tWheels,tBodyType)
            {
                super(tWheels,tBodyType);
                this.color=color;
            }
            whatIsMyName(bodyType)
            {
        ...
        {
            constructor(color,mWheels,mBodyType)
            {
                super(mWheels,mBodyType);
                this.color=color;
            }
            whatIsMyName(bodyType)
            {
